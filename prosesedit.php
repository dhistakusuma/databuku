...
if ($gambar != "") {
    ...
    if (in_array($ekstensi, $ekstensi_gambar) === true) {
        ...
        $query  = "UPDATE perpustakaan SET judul = '$judul', pengarang = '$pengarang', penerbit = '$penerbit', tanggal_masuk = '$tanggal_masuk', gambar = '$gambar_baru'";
        $query .= "WHERE id = '$id'";
    ...
    $query  = "UPDATE perpustakaan SET judul = '$judul', pengarang = '$pengarang', penerbit = '$penerbit', tanggal_masuk = '$tanggal_masuk'";
    $query .= "WHERE id = '$id'";
    $result = mysqli_query($koneksi, $query);
    if (!$result) {
        die("Query gagal dijalankan: " . mysqli_errno($koneksi) .
